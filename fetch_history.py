...
def fetch_all():
    ...
    # NAAIM Exposure Index (naaim) DELETED 2026-06-11. Joe killed NAAIM from
    # the indicator framework on 2026-05-11; the scraper kept running for a
    # month as a half-retired remain (registry entry, tracking row, admin map
    # node) until the 2026-06-11 cleanup. Retired = deleted everywhere.
