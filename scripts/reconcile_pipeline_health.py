...
RETIRED_FEEDS = {
    ...
    # leg died with the vendor on 2026-08-12 and the FINRA leg it still runs
    # writes public.short_interest every morning. Its health row is keyed by the
    # manifest NAME, short_interest_uw_finra. Do not add either string here.
}
