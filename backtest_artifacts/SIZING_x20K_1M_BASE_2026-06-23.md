...
**Starting NAV:** $1,000,000 ($0 Sleeve A + $1,000,000 Sleeve B)
**Ending NAV:** $1,986,658

## Headline numbers

| Metric | Strategy | Benchmark (SPY 50/50) | Spread |
|---|---|---|---|
| Total return (gross) | +99.22% | +29.16% | +70.06% |
| Total return (after 7.5% margin cost) | +98.60% | +29.16% | +69.43% |
| Annualized return (real) | +101.77% | — | — |
| Sharpe (monthly-frequency, real) | 3.04 | — | — |
| Max drawdown | -1.68% | — | — |
| Win rate (weekly) | 70.6% | — | — |
| Annualized turnover | 27.12× | — | — |

## Sleeve attribution

| Sleeve | Start | End | Return |
|---|---|---|---|
| Sleeve A (Asset Tilt IGs) | $0 | $0 | +nan% |
| Sleeve B (Equity Scanner) | $1,000,000 | $1,986,658 | +98.67% |
