...
**Applies to:** Lead Developer — every scheduled delivery, every safety net, and every "the workflow is green" that has not been checked against the thing the reader actually receives.
