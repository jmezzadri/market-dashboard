...
<div style={{fontSize:10,color:"#444"}}>Generated from today's live indicator readings · Powered by Claude</div>
{generatedAt&&<div style={{fontSize:8,color:"#333",fontFamily:"monospace",marginTop:4}}>📅 Generated {generatedAt}</div>}
</div>
<button onClick={generate} disabled={loading}
style={{padding:"8px 20px",borderRadius:4,border:`1px solid ${loading?"#333":CONV.color}`,background:loading?"#111":CONV.color+"20",color:loading?"#555":CONV.color,cursor:loading?"not-allowed":"pointer",fontSize:9,fontFamily:"monospace",fontWeight:700,minWidth:160}}>
...
<div style={{fontSize:7,color:"#444",fontFamily:"monospace",marginBottom:6}}>CURRENT READINGS BEING ANALYZED</div>
...
<span style={{fontSize:7,color:"#555",fontFamily:"monospace"}}>{d[0]}</span>
...
<div style={{fontSize:10,color:"#555",fontFamily:"monospace"}}>Analyzing {Object.keys(IND).length} indicators across rates, credit, banking, labor, and valuation...</div>
<div style={{marginTop:8,fontSize:8,color:"#333",fontFamily:"monospace"}}>Usually takes 5-10 seconds</div>
</div>
)}
...
<div style={{color:"#888",lineHeight:1.85}}>{lines.slice(1).join(" ")}</div>
</>
):(
