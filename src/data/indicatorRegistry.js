...
"High-yield option-adjusted spread (HY OAS) — the spread of US high-yield corporate bonds over Treasuries; the market price of speculative-grade credit risk. NOTE: despite the 'HY–IG' label, this series is HY OAS read straight from FRED (BAMLH0A0HYM2, ×100 → bps, with a curated pre-2023 anchor splice). It is NOT a high-yield-minus-investment-grade subtraction. A relative HY-vs-IG measure is tracked separately as the HY/IG ratio. MacroTilt Tier 1 credit factor; thresholds pending Senior Quant recalibration to HY-OAS levels.",
""],
