...
MACRO STRESS MONITOR v10 · Built with Claude · Data: U.S. Treasury · FRED · CBOE · ICE BofA · FDIC · ISM · BLS · Shiller · NY Fed · Yahoo Finance
</div>
</div>
)}

<div style={{padding:"10px 20px",borderTop:"1px solid #0e0e0e",display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:6}}>
<span style={{fontSize:7,color:"#1e1e1e",fontFamily:"monospace"}}>SOURCES: U.S. Treasury · FRED · CBOE · ICE BofA · FDIC · ISM · BLS · Shiller · Kim-Wright Fed · SLOOS Fed · Yahoo Finance</span>
