...
export default function MethodologyPage({ setPage }) {
  const sections = [
    ...
    <div className="me-body">
      <section className="mt-pagehero">
        <div>
          ...
          <p className="mt-deck">
            Eight sections. Plain English. Every page on the site links here for the underlying logic.
      ...
      <section className="mt-pagesection">
        ...
        <article id="tilt" className="me-section">
          ...
          <div>
            ...
            <p className="me-body-p">
              ...
              max drawdown −32.1% vs −54.6%. Rebalanced weekly; defensive sleeve fires only when stress crosses Watch.
            </p>
            <div className="me-links">
        ...
        <article id="portfolio" className="me-section">
          ...
          <div>
            ...
            <p className="me-body-p">
              Upload Chase, Fidelity, or Schwab CSVs. Wiring a brokerage account via Plaid is coming soon
              and is shown as a disabled control in the UI.
        ...
        <article id="change" className="me-section">
          ...
          <div>
            ...
            <ul className="me-changelog">
              <li><b className="num">2026-05-26</b> — v2 site overhaul preview shipped to feature branch.</li>
