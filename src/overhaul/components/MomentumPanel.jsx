        ...
        <div className="mo-head">
          <div>
            ...
            <div className="mo-rule">
              ...
              qualifiers &rarr; the unfilled slots stay in cash. A held name that closes below all four
              averages is sold that day; the cash waits for the next monthly refresh.
            </div>
          </div>
