  ...
  return (
    <div className="mt-card" style={{ padding: 12, position: 'relative' }}>
      ...
      >
        ...
        {/* axis labels */}
        <text x={W - 16} y={H / 2 - 10} textAnchor="end" fill="var(--mt-ink-2)" style={{ font: 'var(--v13-t1) var(--mt-type-sans)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>stress →</text>
        <text x="16" y={H / 2 - 10} fill="var(--mt-ink-2)" style={{ font: 'var(--v13-t1) var(--mt-type-sans)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>← calm</text>
        <text x={W / 2 + 10} y="28" fill="var(--mt-ink-2)" style={{ font: 'var(--v13-t1) var(--mt-type-sans)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>inflationary ↑</text>
        <text x={W / 2 + 10} y={H - 14} fill="var(--mt-ink-2)" style={{ font: 'var(--v13-t1) var(--mt-type-sans)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>↓ deflationary</text>

        {/* quadrant labels */}
        <text x={W - 24} y="44" textAnchor="end" fill="var(--mt-down)" style={{ font: '600 var(--v13-t2) var(--mt-type-sans)', letterSpacing: '0.15em' }}>RISK OFF · INFL</text>
        <text x="24" y="44" fill="var(--mt-ink-2)" style={{ font: '600 var(--v13-t2) var(--mt-type-sans)', letterSpacing: '0.15em' }}>RISK ON · INFL</text>
        <text x={W - 24} y={H - 28} textAnchor="end" fill="var(--mt-ink-2)" style={{ font: '600 var(--v13-t2) var(--mt-type-sans)', letterSpacing: '0.15em' }}>RISK OFF · DEFL</text>
        <text x="24" y={H - 28} fill="var(--mt-up)" style={{ font: '600 var(--v13-t2) var(--mt-type-sans)', letterSpacing: '0.15em' }}>RISK ON · DEFL</text>
        ...
        <g transform={`translate(${px(-0.55)} ${py(0.45)})`}>
          ...
          <text x="14" y="-26" fill="var(--mt-ink-2)" style={{ font: 'var(--v13-t1) var(--mt-type-sans)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Engine call</text>
          <text x="14" y="-12" fill="var(--mt-accent)" style={{ font: '600 var(--v13-t2) var(--mt-type-sans)' }}>Risk On · Inflationary</text>
        </g>
              ...
              {(isHover || isSel) && (
                <g transform={`translate(${cx > W * 0.7 ? -10 : 10}, ${cy > H * 0.7 ? -36 : -16})`}>
                  ...
                  <text
                    ...
                    y="2"
                    fill="var(--mt-ink-0)"
                    style={{ font: '600 var(--v13-t2) var(--mt-type-sans)' }}
                  >
                    {ind.name}
                  </text>
                  <text
                    ...
                    y="16"
                    fill="var(--mt-ink-2)"
                    style={{ font: 'var(--v13-t1) var(--mt-type-sans)' }}
                  >
